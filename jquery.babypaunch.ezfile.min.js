...
var result=!0;var file=this.file($element);switch($.type(data.ext)){case "string":if(data.ext.toLowerCase()!==file.ext){result=!1;alert("업로드 파일의 확장자는 대소문자 구분없이 "+data.ext+"만 허용됩니다.")}
break;case "array":result=!1;for(var i=0;i<data.ext.length;i++){if(data.ext[i].toLowerCase()===file.ext){result=!0;break}}
...
if(!result){alert("업로드 파일의 용량은 "+byte+unit+" 이하로 제한합니다.")}
